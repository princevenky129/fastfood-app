...
final List<MenuItem> seedMenu = [
  ...
  const MenuItem(
    ...
    price: 90,
    category: MenuCategory.rice,
    photoUrl: 'https://images.unsplash.com/photo-1589302168068-964664d93dc0?auto=format&fit=crop&w=600&q=80',
  ),
  const MenuItem(
    id: 'r10',
  ...
  const MenuItem(
    ...
    price: 160,
    category: MenuCategory.kabab,
    photoUrl: 'https://images.unsplash.com/photo-1628294895950-9805252327bc?auto=format&fit=crop&w=600&q=80',
  ),
  const MenuItem(
    id: 'k6',
  ...
  const MenuItem(
    ...
    price: 50,
    category: MenuCategory.softDrinks,
    photoUrl: 'https://images.unsplash.com/photo-1527661591475-527312dd65f5?auto=format&fit=crop&w=600&q=80',
  ),
  const MenuItem(
    id: 'd7',
